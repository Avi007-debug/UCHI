...
export const getCubbonCHI = USE_MOCK_API ? mockApi.getCubbonCHI : realApi.getCubbonCHI;
export const getBengaluruGeometry = USE_MOCK_API ? mockApi.getBengaluruGeometry : realApi.getBengaluruGeometry;
export const getRVCEGeometry = USE_MOCK_API ? mockApi.getRVCEGeometry : realApi.getRVCEGeometry;
export const getCubbonGeometry = USE_MOCK_API ? mockApi.getCubbonGeometry : realApi.getCubbonGeometry;
